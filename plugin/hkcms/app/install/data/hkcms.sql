...
insert  into `hkcms_config` values (17,'upload','file_type','Upload attachment type','jpg|gif|png|bmp|jpeg|ico|webp|zip|gz|rar|iso|txt|doc|xls|xlsx|ppt|wps|swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov|mp4','textarea',NULL,'格式：value0|value1|value2','','','',0,1,-1,NULL,1);
